...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aggregator.entity_type'
        db.add_column('controller_aggregator', 'entity_type',
                      self.gf('django.db.models.fields.URLField')(default=u'http://ontologies.venturi.eu/base#', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aggregator.entity_type'
        db.delete_column('controller_aggregator', 'entity_type')
    ...
    models = {
        ...
        'controller.aggregator': {
            ...
            'archiveitems': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['controller.ArchiveItem']", 'null': 'True', 'blank': 'True'}),
