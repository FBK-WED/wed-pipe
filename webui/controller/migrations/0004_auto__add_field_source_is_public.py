...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'controller_source', 'is_public',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'controller_source', 'is_public')
    ...
    models = {
        ...
        u'controller.archiveitem': {
            ...
            'rule': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['controller.Rule']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
