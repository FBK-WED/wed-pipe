...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArchiveItem.rule'
        db.alter_column(u'controller_archiveitem', 'rule_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['controller.Rule'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'ArchiveItem.rule'
        db.alter_column(u'controller_archiveitem', 'rule_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['controller.Rule'], unique=True, null=True))
