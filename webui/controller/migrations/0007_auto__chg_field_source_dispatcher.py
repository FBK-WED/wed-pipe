...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.dispatcher'
        db.alter_column(u'controller_source', 'dispatcher', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Source.dispatcher'
        db.alter_column(u'controller_source', 'dispatcher', self.gf('django.db.models.fields.TextField')())
