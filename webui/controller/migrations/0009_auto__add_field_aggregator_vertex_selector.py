...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aggregator.vertex_selector'
        db.add_column(u'controller_aggregator', 'vertex_selector',
                      self.gf('django.db.models.fields.TextField')(default="g.V('type', 'g.V('type', 'sd$Something')%limit.id.fill(m)')"),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aggregator.vertex_selector'
        db.delete_column(u'controller_aggregator', 'vertex_selector')
    ...
    models = {
        ...
        u'controller.aggregator': {
            ...
            'vertex_selector': ('django.db.models.fields.TextField', [], {'default': '"g.V(\'type\', \'g.V(\'type\', \'sd$Something\')%limit.id.fill(m)\')"'})
        },
