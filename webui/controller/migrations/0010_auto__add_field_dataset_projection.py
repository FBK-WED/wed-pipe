...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset.projection'
        db.add_column(u'controller_dataset', 'projection',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.projection'
        db.delete_column(u'controller_dataset', 'projection')
