# -*- coding: utf-8 -*-
"""
This is a fake migration with no code in forwards and backwards. It just fixes
the models dict to introduce an explicit M2M model between Aggregator and
ArchiveItem
"""
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.send_create_signal(u'controller', ['AggregatorArchiveItem'])
